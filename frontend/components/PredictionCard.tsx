        ...
        >
          ...
          >
            <span
              ...
              style={{ background: "linear-gradient(135deg,#CC1500,#D4A017)", color: "#ffffff", boxShadow: "0 2px 12px rgba(212,160,23,0.4)" }}
            >
      ...
      {open && (
        ...
        >
          <button
            ...
            style={{ background: "rgba(212,160,23,0.9)", color: "#ffffff", boxShadow: "0 2px 16px rgba(212,160,23,0.4)" }}
          >
            <X size={18} />
          </button>
...
if (!PAYSTACK_KEY) {
  console.error('[Africa Tips] NEXT_PUBLIC_PAYSTACK_KEY is not set. Payment will not work.');
}
...
const ACCENT: Record<string, { bg: string; text: string; glow: string; border: string }> = {
  "2+":  { bg: "rgba(212,160,23,0.1)",  text: "#D4A017", glow: "rgba(212,160,23,0.25)",  border: "rgba(212,160,23,0.3)" },
  "5+":  { bg: "rgba(204,21,0,0.1)",    text: "#CC1500", glow: "rgba(204,21,0,0.25)",    border: "rgba(204,21,0,0.3)" },
  "10+": { bg: "rgba(42,122,42,0.1)",   text: "#2A7A2A", glow: "rgba(42,122,42,0.25)",   border: "rgba(42,122,42,0.3)" },
  "20+": { bg: "rgba(212,160,23,0.15)", text: "#F5C030", glow: "rgba(212,160,23,0.3)",   border: "rgba(212,160,23,0.4)" },
};
  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      >
        ...
        <div style={{ height: "3px", background: "linear-gradient(90deg,#CC1500,#D4A017,#F5C030)", width: "100%" }} />
        ...
        <div className="px-5 py-4 space-y-2.5">
          ...
          >
            ...
            <div style={{ width: 28, height: 28, borderRadius: 8, background: "rgba(212,160,23,0.1)", border: "1px solid rgba(212,160,23,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4A017" strokeWidth="2.5"><path d="M9 18l6-6-6-6"/></svg>
            </div>
          </button>
  ...
  if (step === "verifying") {
    return ReactDOM.createPortal(
      ...
      >
        ...
        >
          <div style={{ height: "3px", background: "linear-gradient(90deg,#CC1500,#D4A017,#F5C030)", width: "100%", position: "absolute", top: 0, left: 0 }} />
          <div
            className="w-16 h-16 rounded-2xl flex items-center justify-center"
            style={{ background: "rgba(212,160,23,0.1)", border: "1px solid rgba(212,160,23,0.25)", boxShadow: "0 0 30px rgba(212,160,23,0.15)" }}
          >
        ...
        <div className="px-5 pt-4 pb-2 flex gap-2">
          {(["pay", "restore"] as ModalTab[]).map((t) => (
            <button
              ...
              style={{
                background: tab === t ? "linear-gradient(135deg,#CC1500,#D4A017)" : "rgba(255,255,255,0.04)",
                color: tab === t ? "#ffffff" : "#52525b",
                border: tab === t ? "none" : "1px solid rgba(255,255,255,0.06)",
                boxShadow: tab === t ? "0 2px 12px rgba(212,160,23,0.35)" : "none",
        ...
        {tab === "pay" ? (
          <>
            ...
            <div className="px-5 pb-5 space-y-3">
              <div>
                <label className="block text-xs font-bold mb-1.5" style={{ color: "rgba(212,160,23,0.9)", letterSpacing: "0.08em", textTransform: "uppercase", fontSize: "0.62rem" }}>Email address</label>
                <input
              ...
              <button
                ...
                style={{
                  background: step === "paying" ? "rgba(212,160,23,0.4)" : "linear-gradient(135deg,#CC1500,#D4A017)",
                  color: "#ffffff",
                  boxShadow: step === "paying" ? "none" : "0 4px 20px rgba(212,160,23,0.4)",
                  letterSpacing: "0.03em",
                }}
              >
                {step === "paying"
          ...
          <div className="px-5 py-4 space-y-3">
            <div
              ...
              style={{ background: "rgba(212,160,23,0.06)", border: "1px solid rgba(212,160,23,0.15)" }}
            >
              <Mail size={15} className="flex-shrink-0 mt-0.5" style={{ color: "#D4A017" }} />
            ...
            <div>
              <label className="block text-xs font-bold mb-1.5" style={{ color: "rgba(212,160,23,0.9)", letterSpacing: "0.08em", textTransform: "uppercase", fontSize: "0.62rem" }}>Email used at payment</label>
              <input
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 font-bold text-sm py-3.5 rounded-2xl transition-all duration-300 active:scale-[0.97]"
              style={{
                background: restoreLoading ? "rgba(212,160,23,0.4)" : "linear-gradient(135deg,#CC1500,#D4A017)",
                color: "#ffffff",
                boxShadow: restoreLoading ? "none" : "0 4px 20px rgba(212,160,23,0.35)",
                letterSpacing: "0.03em",
              }}
            >
              {restoreLoading
      ...
      >
        ...
        <div className="px-5 pt-4">
          ...
          >
            ...
            <div style={{ height: "1px", background: "rgba(212,160,23,0.1)", marginBottom: "0.75rem" }} />
            {/* Bank details */}
        ...
        <div className="px-5 py-4 space-y-2.5">
          <a
            href="https://t.me/mr_kinghh"
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-center gap-2 font-bold text-sm py-3.5 rounded-2xl transition-all duration-300 active:scale-[0.97]"
            style={{
              background: "linear-gradient(135deg,#CC1500,#D4A017)",
              color: "#ffffff",
      ...
      <div style={{ padding: "1.25rem 1.25rem 1rem" }}>
        ...
        <div
          ...
          style={{
            ...
            color: "#ffffff",
            letterSpacing: "0.03em",
            boxShadow: "0 4px 20px rgba(212,160,23,0.0)",
            transition: "box-shadow 0.3s ease",
          }}
          onMouseEnter={e => ((e.currentTarget as HTMLElement).style.boxShadow = "0 6px 28px rgba(212,160,23,0.45)")}
          onMouseLeave={e => ((e.currentTarget as HTMLElement).style.boxShadow = "0 4px 20px rgba(212,160,23,0.0)")}
        >
