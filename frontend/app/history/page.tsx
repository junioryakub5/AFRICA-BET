          ...
          {!loading && predictions.length > 0 && (
            ...
            >
              ...
              <div className="flex items-center gap-3 md:ml-auto flex-wrap justify-center">
                ...
                >
                  <span className="text-2xl font-black" style={{ color: "#D4A017" }}>{predictions.length}</span>
  ...
  return (
    <div className="card-glass overflow-hidden">
      ...
      >
        ...
        {hasImages ? (
          <span className="text-xs font-semibold flex items-center gap-1" style={{ color: "#D4A017" }}>
